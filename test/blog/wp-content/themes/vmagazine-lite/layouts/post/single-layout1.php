...
<div id="primary" class="content-area post-single-layout1 vmagazine-lite-content">
	<main id="main" class="site-main" role="main">
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<?php $vmagazine_lite_sg_meta_data_enable = get_theme_mod('vmagazine_lite_sg_meta_data_enable','show');
			if($vmagazine_lite_sg_meta_data_enable == 'show'){ ?>
			<div class="entry-meta clearfix">
				<?php vmagazine_lite_icon_meta(); ?>
			</div><!-- .entry-meta -->
			<?php } ?>
			<?php
			$show_img = get_theme_mod('vmagazine_lite_sg_image_enable','show');
			if($show_img == 'show'){ 
			...
			<div class="entry-content clearfix">
				...
				<div class="entry-content clearfix">
					<?php $show_tag = get_theme_mod('vmagazine_lite_sg_tags_enable','show');
					if($show_tag == 'show'){ ?>
	                    <?php if( has_tag() ) : ?>
	                    <div class="post-tag">
