...
<thead>
  <tr class="th" >
   ...
   <th width="19%" align="center" valign="middle">Action</th>
   <th width="19%" align="center" valign="middle">Both Profiles</th>
  </tr>
  </thead>
  ...
  <td><select name="sel_bothsideinterest" class="sel_bothsideinterest form-control">
    ...
    <option value="closeticket" <?php if($hold->kv_msi_rmstatus=='closeticket'){?>selected="selected"<?php } ?> id="<?php echo $hold->kv_msi_id;?>"><?php echo getlangkeywords('dd_closetickets');?></option>
    
    </select></td>
    <td width="19%" align="center" valign="middle"><a href="<?php echo base_url();?>admin/mmstwoprofiles?pid1=<?php echo $hold->kv_msi_profilefkid;?>&pid2=<?php echo $hold->kv_msi_interested_on;?>&inid=<?php echo $hold->kv_msi_id;?>" target="new">Profiles</a></td>
  </tr>
 <?php //}
  }?>
</table>
