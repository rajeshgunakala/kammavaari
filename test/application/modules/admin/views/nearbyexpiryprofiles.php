...
<div class="new-side-content">
          ...
          <h3 style="text-align:center;">Nearby expiring profiles</h3>
...
<thead>
  <tr class="th" >   
	...
	<th width="12%" align="center" valign="middle">Expire By</th>
    <th width="20%" align="center" valign="middle">Name</th>
	<th width="15%" align="center" valign="middle">Profile Id</th>
    <!-- <th width="10%" align="center" valign="middle">Mobile</th> -->
  ...
  <tr role="row" class="odd ">
	...
	<td align="center" valign="middle"><?php echo date('m/d/Y', strtotime($hold->expiry_date));  ?></td>
  ...
  <td align="left" valign="middle"><a href="<?php echo base_url();?>admin/admin_search/viewprofile/<?php echo $hold->id;?>" target="_blank">View Profile</a> | <a href="<?php echo base_url();?>admin/call_history?profileId=<?php echo $hold->profile_id;?>" target="_blank">Marketing</a></td>
