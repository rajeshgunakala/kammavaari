...
<div class="col-md-12 no-padding" style="margin-top: 30px;">
   <div class="col-md-12 no-padding">
      <h3 style="text-align:center;">MySide Followup Interests</h3>
      <div style="margin-bottom:10px;" id="notification">
      </div>
		<?php if(!empty($user_data)) {?>
         
         <div class="col-md-12 no-padding" id="dataList" style="width:100%;">
                  ...
                  <div class="col-sm-12 compareprofile">
                     <div class="completeProfileLeftPanWrapper">
                        <div class="CPProfileLefDetailwOuter CPPrifileLeftProfileIntraction">
                           <div class="CPProfileLefDetail">                              
							  <ul>
                                 ...
                                 <li class="displayInline"><span class="btn btn-xs custBtnPInt btn-primary" data-toggle="modal" data-target="#marketing_history" rel1="<?php echo $profile_1;?>" onclick="marketing_history(<?php echo $profile_2;?>)">CALL ENTRY</span></li>
                        ...
                        <div class="CPProfileImgNameOuter">
                           <div class="CPProfileImg"><img src="<?php echo $profile_pic1[0]['applicationphotopath'];?>" ></div>
                           ...
                           <div class="CPProfileData contact-details"><strong class="label">Mobile1:</strong> <?php echo $primary_info1['mobile'];?></div>
            ...
            <div class="col-md-6 profile2 no-padding">
               <div class="row-fluid">
                  <div class="col-sm-12 compareprofile">
                     <div class="completeProfileLeftPanWrapper">
                        <div class="CPProfileImgNameOuter">
                           <div class="CPProfileImg"><img src="<?php echo $profile_pic2[0]['applicationphotopath'];?>" ></div>
