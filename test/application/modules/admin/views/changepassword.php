		<div class="main-content">
				<div class="main-content-inner">
					<!-- #section:Changepasswords/content.breadcrumbs -->
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL; ?>Changepassword">Changepassword</a>
							</li>
						</ul><!-- /.breadcrumb -->
					
						<!-- /section:Changepasswords/content.searchbox -->
					</div>
					...
					<div class="page-content">
							...
							<div class="ace-settings-box clearfix" id="ace-settings-box">
								...
								<div class="pull-left width-50">
									<!-- #section:Changepasswords/sidebar.options -->
									<div class="ace-settings-item">
							...
							<h3 class="header smaller lighter blue">Changepassword </h3>
							<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
										...
										<?php } ?>
								<form class="form-horizontal" name="myform" action="<?php echo ADMIN_URL;?>Changepassword" id="myform" method="post"  enctype="multipart/form-data" role="form">
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Current Password : </label>
										<div class="col-sm-9">
										    <input type="password" name="cur_pass" value="" required placeholder="Current Password" class="col-xs-10 col-sm-5">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input required type="password" value=""  name="password" id="password" placeholder="Password"  class="col-xs-10 col-sm-5">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<input required type="password" value=""  placeholder="Confirm Password" name="confirm_password" id="confirm_password" class="col-xs-10 col-sm-5">
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a  href="<?php echo ADMIN_URL;?>Changepassword" class="btn" type="reset">
...
<![endif]-->
	...
	*/
	...
	$('#id-input-file-1 , #id-input-file-2').ace_file_input({
		...
		<!-- inline scripts related to this page -->
	<script type="text/javascript">
	function getsubcat(valu){
					
							
							$.ajax({ 
							   type: "POST", url: '<?php echo PRADEEP_ADMIN;?>Changepassword/subcat', data: "valu="+valu,
