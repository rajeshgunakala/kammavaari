			            ...
			            <div class="row">
			                ...
			                <div class="col-xs-12">
			                    ...
			                    <form class="form-horizontal" name="myform" id="myform" method="post"
									...
									<h2 style="font-family: 'Roboto', sans-serif; margin-left: 10px;">Edit Couple Page</h2>
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-sm-9">
			                                <input type="text" id="form-field-1" required name="title"
			                                    placeholder="Enter Couple Names Seperated bY Comma"
			                                    value="<?php echo $record['title'];?>" class="col-xs-10 col-sm-5" />
			                            </div>
			                        </div>
			                        <div class="form-group">
			                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Precious Image
			                                : </label>
			                            <div class="col-sm-9">
			                                <img style="width:150px;height:100px;"
			                                    src="<?php echo site_url();?>images/successstories/<?php echo $record['image'];?>" />
			                            </div>
			                        </div>
			                        <div class="form-group">
			                        ...
			                        <div class="form-group">
			                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Content :
			                            </label>
			                            <div class="col-sm-9">
			                                <script src="//cdn.ckeditor.com/4.5.9/full/ckeditor.js"></script>
			                                <textarea
			                                    name="content"><?php echo stripcslashes(str_replace("\n","", $record['content'])); ?></textarea>
			                                <script>
