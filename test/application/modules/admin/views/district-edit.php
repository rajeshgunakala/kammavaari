					...
					<div class="page-content">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
										...
										<div class="col-sm-9">
											<select type="text" id="form-field-1"  required name="country_id"  class="col-xs-10 col-sm-5" onchange="getstates(this.value)"/>
											<option>Select Country</option>
											<?php foreach($countries as $value) { ?>
											<option <?php if($record['country_id'] ==$value['id']) { ?> selected <?php } ?> value="<?php echo $value['id'];?>"><?php echo ucwords($value['country']);?></option>
											<?php } ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Select State : </label>
										<div class="col-sm-9">
											<select id="state_id" required name="state_id" class="col-xs-10 col-sm-5" />
											<option>Select Country First</option>
												<?php foreach($states as $value) { ?>
											<option <?php if($record['state_id'] ==$value['id']) { ?> selected <?php } ?> value="<?php echo $value['id'];?>"><?php echo ucwords($value['state']);?></option>
											<?php } ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9"> 
										<input type="text" value="<?php echo $record['district'];?>" name="district" required class="col-xs-10 col-sm-5" placeholder="Enter District"/>
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										...
										<div class="col-md-offset-3 col-md-9">
											...
											<a class="btn" href="<?php echo ADMIN_URL;?>District">
	...
	*/
	...
	$('#id-input-file-1 , #id-input-file-2').ace_file_input({
		...
		function getstates(valu)
		{
			$.ajax({ 
			   type: "POST", 
			   url: '<?php echo ADMIN_URL;?>District/getstates',
			   data: "valu="+valu,
