							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
										...
										<div class="col-sm-9">
											...
											<option value="<?php echo $value['id'];?>"><?php echo ucwords($value['country']);?></option>
											<?php } ?>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9"> 
										<input type="text" name="district" required class="col-xs-10 col-sm-5" placeholder="Enter District"/>
										</div>
									</div>
