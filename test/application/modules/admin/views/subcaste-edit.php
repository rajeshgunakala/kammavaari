					...
					<div class="page-content">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
										...
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Select Caste : </label>
										<div class="col-sm-9">
											<select type="text" id="form-field-1"  required name="caste_id"  class="col-xs-10 col-sm-5"/>
											<option>Select Caste</option>
											<?php foreach($categories as $value) { ?>
											<option <?php if($value['id'] ==$record['caste_id']) { ?> selected <?php } ?> value="<?php echo $value['id'];?>"><?php echo ucwords($value['caste']);?></option>
											<?php } ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Subcaste : </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  required name="subcaste" placeholder="Enter subcaste" value="<?php echo $record['subcaste'];?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										...
										<div class="col-md-offset-3 col-md-9">
											...
											<a class="btn" href="<?php echo ADMIN_URL;?>Subcaste">
