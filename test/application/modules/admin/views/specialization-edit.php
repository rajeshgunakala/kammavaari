					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo ADMIN_URL; ?>District">District</a>
					...
					<div class="page-content">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
										...
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Select Heighst Education : </label>
										<div class="col-sm-9">
											<select type="text" id="form-field-1"  required name="hid"  class="col-xs-10 col-sm-5" onchange="getdegree(this.value)"/>
											<option>Select Heighst Education</option>
											<?php foreach($heighsteducations as $value) { ?>
											<option <?php if($record['hid'] ==$value['id']) { ?> selected <?php } ?> value="<?php echo $value['id'];?>"><?php echo ucwords($value['heighsteducation']);?></option>
											<?php } ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Select Education Degree : </label>
										<div class="col-sm-9">
											<select id="eid" required name="eid" class="col-xs-10 col-sm-5" />
											<option>Select Education Degree</option>
												<?php foreach($degree as $value) { ?>
											<option <?php if($record['eid'] ==$value['id']) { ?> selected <?php } ?> value="<?php echo $value['id'];?>"><?php echo ucwords($value['educationdegree']);?></option>
											<?php } ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9"> 
										<input type="text" value="<?php echo $record['specialization'];?>" name="specialization" required class="col-xs-10 col-sm-5" placeholder="Enter Specialization"/>
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										...
										<div class="col-md-offset-3 col-md-9">
											...
											<a class="btn" href="<?php echo ADMIN_URL;?>Specialization">
	...
	*/
	...
	$('#id-input-file-1 , #id-input-file-2').ace_file_input({
		...
		function getdegree(valu)
		{
			$.ajax({ 
			   type: "POST", 
			   url: '<?php echo ADMIN_URL;?>Specialization/getdegree',
			   data: "valu="+valu,
