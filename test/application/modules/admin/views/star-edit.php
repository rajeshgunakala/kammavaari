							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  required name="star" placeholder="Enter Star" value="<?php echo $record['star'];?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										...
										<div class="col-md-offset-3 col-md-9">
											...
											<a class="btn" href="<?php echo ADMIN_URL;?>Star">
