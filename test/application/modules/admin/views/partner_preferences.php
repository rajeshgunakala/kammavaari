   ...
   <div id="page-inner" style="background:#ffffff">
       <div class="container" style="margin-top:40px;">
           <div class="row col-xs-12" style="border: 1px solid #f2f2f2;box-shadow: 0px 0px 10px 0px #f2f2f2;padding-right: 0;padding-left: 0;">
               ...
               <div class="col-xs-3 col-md-3  no-padding" style="background: #eeeeee;">
...
<!-- 
 ...
 -->
        ...
        <select name="marital_status[]" id="marital_status" class="js-example-basic-multiple form-control" multiple="multiple">
            <option selected="selected" value="never_married" <?php if(in_array("never_married", array_map('trim', $maritalstatus))) echo 'selected'; ?>>Never Married</option>
            <option value="divorced" <?php if(in_array("divorced", array_map('trim', $maritalstatus))) echo 'selected'; ?>>Divorced</option>
            <option value="widow-widower" <?php if(in_array("widow-widower", array_map('trim', $maritalstatus))) echo 'selected'; ?>>Widow / Widower</option>
            <option value="separated" <?php if(in_array("separated", array_map('trim', $maritalstatus))) echo 'selected'; ?>>Separated</option>
            <option value="annulled" <?php if(in_array("annulled", array_map('trim', $maritalstatus))) echo 'selected'; ?>>Annulled</option>
        </select>
    </div>
                      <div class="col-md-6 col-sm-6 col-xs-6">
                        <label for="employeein">Employee In</label><br/>
                        <select  class="js-example-basic-multiple form-control" id="employee_in" name="employee_in[]" multiple="multiple">
                               <option  value="Government" <?php if(in_array("Government",array_map('trim', $employeeIn))) echo 'selected' ?>>Government</option>
                               <option  value="Private" <?php if(in_array("Private",array_map('trim', $employeeIn))) echo 'selected' ?>>Private</option>
                               <option  value="Business" <?php if(in_array("Business",array_map('trim', $employeeIn))) echo 'selected' ?>>Business</option>
                               <option  value="Defencce" <?php if(in_array("Defencce",array_map('trim', $employeeIn))) echo 'selected' ?>>Defencce</option>
                               <option  value="Student" <?php if(in_array("Student",array_map('trim', $employeeIn))) echo 'selected' ?>>Student</option>
                               <option  value="Not-Working" <?php if(in_array("Not-Working",array_map('trim', $employeeIn))) echo 'selected' ?>>Not-Working</option>
                ...
                <div class="row m-0"> 
                      <div class="col-md-6 col-sm-6 col-xs-6">
                        ...
                        <select  name="education_level[]" id="education_level" class="js-example-basic-multiple form-control" multiple="multiple">
                          <?php foreach($educations as $value) { ?>
                          <option value="<?php echo $value['heighsteducation'];?>" <?php if(in_array($value['heighsteducation'],array_map('trim', $education))) echo 'selected' ?>><?php echo stripcslashes($value['heighsteducation']);?></option><?php } ?>
                        </select>
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-6">
                        <label>Caste</label><br/>
                        <select name="caste[]" id="caste" class="js-example-basic-multiple form-control" multiple="multiple">
    <?php foreach($castes as $value) { ?>
        <option value="<?php echo $value['caste'];?>" <?php if($value['caste'] == 'Kamma' || in_array($value['caste'], array_map('trim', $casteArr))) echo 'selected'; ?>><?php echo stripcslashes($value['caste']);?></option>
    <?php } ?>
</select>
                      </div>
                    </div>
                    ...
                    <div class="row m-0"> 
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-6">
                        <label>Star</label><br/>
                        <select  name="star[]" id="star" class="js-example-basic-multiple form-control" multiple="multiple">
                          <?php foreach($stars as $value) {?>
                          <option value="<?php echo $value['star'];?>" <?php if(in_array(trim($value['star']),array_map('trim', $starArr))) echo 'selected' ?>><?php echo stripcslashes($value['star']);?></option><?php } ?>
                        </select>
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-6">
                        <label>Mother Tongue</label><br/>
                        <select  name="mother_tongue[]" id="mother_tongue" class="js-example-basic-multiple form-control" multiple="multiple">
                          <?php foreach($mothertounges as $value) { ?>
                            <option value="<?php echo $value['mothertounge'];?>" <?php echo ((!empty($mothertounge) && in_array(stripcslashes($value['mothertounge']), array_map('trim', $mothertounge))) || $value['mothertounge'] === 'Telugu') ? 'selected' : ''; ?>><?php echo stripcslashes($value['mothertounge']);?></option>
<?php } ?>
                        </select>
                      </div>
                          </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-6">
                        ...
                        <select  name="profession[]" id="profession" class="js-example-basic-multiple form-control" multiple="multiple">
                          <?php foreach($professions as $value) { ?>
                          <option value="<?php echo $value['profession'];?>" <?php if(in_array($value['profession'],array_map('trim', $profession))) echo 'selected' ?>><?php echo stripcslashes($value['profession']);?></option><?php } ?>
                        </select>
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-6">
                        <label>Country</label><br/>
                        <select  name="country[]" id="country" class="js-example-basic-multiple form-control" multiple="multiple">
                          <?php foreach($countries as $value) { ?>
                          <option value="<?php echo $value['country'];?>" <?php if(in_array($value['country'],array_map('trim', $country))) echo 'selected' ?>><?php echo stripcslashes($value['country']);?></option><?php } ?>
                        </select>
                      </div>
                      </div>
                      <div class="row m-0"> 
