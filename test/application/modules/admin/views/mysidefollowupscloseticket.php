...
<thead>
  ...
  <tr role="row" class="odd">
    ...
    <td align="center" valign="middle"><?php echo ucfirst($hold->clientfname.' '.$hold->clientlname);?></strong>(<a href="<?php echo base_url();?>/admin/admin_search/viewprofile/<?php echo $hold->kv_msi_profilefkid;?>" target="new"><?php echo $hold->clientprofileid;?></a>)</td>
    <td align="center" valign="middle"><?php echo ucfirst($hold->intonclientfname.' '.$hold->intonclientlname);?></strong>(<a href="<?php echo base_url();?>/admin/admin_search/viewprofile/<?php echo $hold->kv_msi_interested_on;?>" target="new"><?php echo $hold->intonclientprofileid;?></a>)</td>
