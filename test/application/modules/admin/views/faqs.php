    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo ADMIN_URL; ?>faqs">Faqs</a>
                </li>
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form method="post" action="<?php echo ADMIN_URL; ?>faqs/delete_selected">
                        <div class="clearfix">
                            <div class="pull-left tableTools-container"></div>
                       <div class="pull-right">
                            <a  href="<?php echo ADMIN_URL; ?>faqs/add"  class="btn btn-primary">
                                    ...
                                    if (count($record) > 0) {
                                        ...
                                        foreach ($record as $key => $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo stripcslashes($row['question']); ?></td>
                                                <td><?php $cdata4 = preg_replace('/<[^>]*>/', '', $row['content']);
                                            echo substr(stripcslashes(str_replace("\n", "", $cdata4)), 0, 100); ?></td>
                                         <td><span <?php if($row['status']== 1){ echo " class='label label-success arrowed-in arrowed-in-right'"; } elseif($row['status']== 0){ echo "class='label label-danger arrowed'"; } ?>><a href="JavaScript:if(confirm('Are you sure want to Chanage the Status?')==true){window.location='<?php echo ADMIN_URL;?>faqs/status/<?php echo $row['id']?>/<?php echo $row['status'];?>';}" style="color:#FFF; text-decoration:none;"><?php if($row['status']== 1){ echo "Active"; } elseif($row['status']== 0){ echo "De-Active"; } ?></a></span></td>

                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">

                                                        <a class="green" href="<?php echo ADMIN_URL; ?>faqs/edit/<?php echo $row['id']; ?>">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>

                                                        <a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>faqs/delete/<?php echo $row['id']; ?>';}">
                                                    ...
                                                    <div class="hidden-md hidden-lg">
                                                        <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                ...
                                                                <li>
                                                                    <a href="<?php echo ADMIN_URL; ?>faqs/edit/<?php echo $row['id']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                        <span class="green">
                                                                ...
                                                                <li>
                                                                    <a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL; ?>faqs/delete/<?php echo $row['id']; ?>';}" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                        <span class="red">
