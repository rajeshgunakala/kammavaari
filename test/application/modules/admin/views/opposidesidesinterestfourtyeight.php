...
<div class="col-md-9 no-padding" style="margin-top: 90px;">
   <div class="col-md-12 no-padding">
      <h3>Opposite Side Interested Pending from 48 Hours</h3>
                  ...
                  <div class="col-sm-12 compareprofile">
                     <div class="completeProfileLeftPanWrapper">
                        <div class="CPProfileImgNameOuter">
                           ...
                           <div class="CPProfileName"> <?php echo ucfirst($primary_info2['first_name'] . ' ' . $primary_info2['last_name']);?> (<a href="<?php echo base_url();?>admin/admin_search/viewprofile/<?php echo $profile_2;?>" target="_blank"><?php echo $primary_info2['profile_id'];?></a>) </div>
                        ...
                        <div class="CPProfileLefDetailwOuter CPPrifileLeftProfileIntraction">
                           <div class="CPProfileLefDetail">
                              <ul>
                                 ...
                                 <li class="displayInline"><button class="btn btn-xs custBtnPInt btn-primary" onclick="profile_submit_action(<?php echo $profile_inid; ?>, 'consultrm')">Consult <?php echo ucfirst($rm_profile1->username);?></button></li>
								 ...
								 <li class="displayInline"><span class="btn btn-xs custBtnPInt btn-primary" data-toggle="modal" data-target="#myModal_create_reminder" rel1="<?php echo $profile_2;?>" onclick="create_reminder(<?php echo $profile_2;?>)">Create Reminder</span></li>
                              </ul>
                           </div>
                        </div>
