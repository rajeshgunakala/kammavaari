					...
					<div class="page-content">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
										...
										<div class="col-sm-9">
												<select type="text" id="form-field-1"  required name="country_id"  class="col-xs-10 col-sm-5"/>
											<option>Select Caste</option>
											<?php foreach($countries as $value) { ?>
											<option <?php if($value['id']==$record['country_id']) { ?> selected <?php } ?> value="<?php echo $value['id'];?>"><?php echo ucwords($value['country']);?></option>
											<?php } ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  required name="state" placeholder="Enter State" value="<?php echo $record['state'];?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										...
										<div class="col-md-offset-3 col-md-9">
											...
											<a class="btn" href="<?php echo ADMIN_URL;?>State">
