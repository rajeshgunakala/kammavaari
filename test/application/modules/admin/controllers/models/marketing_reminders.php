        ...
        <div style=" width:100%;float:left; font-size:1vw; margin:0px;">
            <div style="float:left; margin-right:1vw;">
                <div class="form-group form-inline">                  
                    <input type="radio" class="radio-inline" checked name="reminder_type" value="1" style="margin-top: 13px;">
                    <label class="form-group">Today Reminders</label>  
                </div>
            </div>

            <div style="float:left; margin-right:1vw;">
                <div class="form-group form-inline">                    
                    <input type="radio" class="radio-inline" checked name="reminder_type" value="0" style="margin-top: 13px;">
                    <label class="form-group">Expired Reminders</label>
                </div>
            </div>

            <div style="float:left; margin-right:1vw;">
                <div class="form-group form-inline">
                    <label class="form-group">From Reminder Dates</label>
                    <input type="text" class="form-group form-control" style="width:8vw;" id="dor_from" />
                </div>
            </div>

            <div style="float:left; margin-right:1vw;">
                <div class="form-group form-inline">
                    <label class="form-group">To Reminder Dates : </label>
...
<script>
    $(document).ready(function() {
        ...
        $('#search_prof_emp').click(function() {            
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>admin/Admin_ap/get_market_reminder_search",
                dataType: 'json',
                data: {
                    emp_id: em_selected,
                    dor_from: dor_from,
