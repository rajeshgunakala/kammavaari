...
class Admin_dashboard_model extends CI_Model
{
    ...
    {
        $this->db->select('tbl_primary_info.id,tbl_primary_info.first_name,tbl_primary_info.last_name, tbl_primary_info.date,tbl_primary_info.registered_on,tbl_primary_info.profile_id,tbl_primary_info.mobile,tbl_primary_info.email, tbl_primary_info.is_Mverified, tbl_primary_info.is_Everified,MS_photos.photoname, ms_profilesetting.elite, ms_profilesetting.ms_usertype');
        $this->db->from('tbl_primary_info');
...
//echo $this->db->last_query();exit;
    ...
    {
        $this->db->select('tbl_primary_info.mobile, tbl_primary_info.email, tbl_contact_info.*');
        $this->db->from('tbl_primary_info');
    ...
    public function contactDetailUpdate($dataArr, $priInfoArr, $userid)
    {
        $this->db->where('user_id', $userid);
    ...
    public function contactDetailsInsert($dataArr, $priInfoArr, $userid)
    {
    ...
    public function getIDToServiceData($Tid)
    {
        ...
        $this->db->or_where('(from_msID = '.$Tid.' AND rev_sent= '.$status.')');
