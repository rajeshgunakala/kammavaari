...
<div class="main__content teamSinglePage pb-0">
	 <div class="row main_content_top">
		<div class="container">
			 <div class="row m-0">
	            	<a class="back_link pl-2 mb-3" href="<?php echo site_url(); ?>dashboard/index"><i class="icofont-circled-left back_link_arrow"></i> Back to Dashboard</a>
	            </div>
			<div class="row main_content_top">
				<p class="col-md-12 heading">
					<span><?php echo $total_new_profiles?></span>  New Matched Profiles 
				</p>
			</div>
			<div class="row">
				<div class="col-md-9">
        								   ...
        								   <?php 
        								      if($pprimary_info["ms_usertype"]=='regular') 
        									   { 
        									       ...
        									       if($expdate > $curdate)
        									       { ?>
        									           <a href="javascript:void(0)" class="profile_detail_icons" data-toggle="modal" data-target="#showexpmodelpopup"><i class="icofont-heart-alt"></i></a>
        									       <?php }
        									       else
        									       {
        									   ...
        									   { 
        									       ...
        									       { 
        									            ...
        									            $viewprofilesbyuser = count($countprofileviwesbyuser);
                        					             ...
                        					             ?>
                        					             <a href="javascript:void(0)" class="btn btn-black max-206 m-2 btn-grad-orange"  data-toggle="modal" data-target="#viewprofilemodelpopup">View Profile</a>
                        					             <?php
                        					             }
                        					             else
                        					             { 
        									       ...
        									       { ?>
        									           <a href="javascript:void(0)" class="btn btn-black max-206 m-2 btn-grad-orange"  data-toggle="modal" data-target="#showexpmodelpopup">View Profile</a>
        									       <?php }          
