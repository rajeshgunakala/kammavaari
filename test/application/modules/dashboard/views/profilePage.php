...
<div class="main_content">
		<?php if($this->uri->segment(3)!='view_profile') { ?>
			<div class="container">
	            <div class="row m-0">
	            	...
	            	<div class="search_section">
		            	<div class="row pt-2 pb-5">
					        ...
					        <div class="my_profile_main col-md-6">
				                ...
				                <span class="profile_info"><strong> Hello <?php echo $my_details['last_name'];?></strong>, If you find the basic details of <strong><?php echo $primary_info['last_name'];?> (<?php echo $primary_info['profile_id']; ?>)</strong>, suitable please click on send interest ❤️ button. On doing so you will be accessible to view her more information. </span>
		            	...
		            	<div class="tab-nav col-md-12">
							...
							<!--	<li class="nav-item" role="presentation">
									<a class="nav-link" id="pills-payment-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Contact</a>
								</li>  -->
								<li class="nav-item" role="presentation">
							...
							<div class="col-md-12 tab-content" id="pills-tabContent">
								...
								<div class="tab-pane fade show active" id="pills-basic-info" role="tabpanel" aria-labelledby="pills-basic-info-tab">
									<div class="dashboard_main_content">
										...
										<!-- <div class="row pb-3">
										  	<p class="col-md-4 attribute_name">Highest Education:</p>
											<p class="col-md-8 attribute_value"><?php if($profession_info['heighst_education']!='') { echo $profession_info['heighst_education']; } else{ echo "N/A"; }?></p>
										</div>
										<div class="row pb-3">
											<p class="col-md-4 attribute_name">Specialization:</p>
											<p class="col-md-8 attribute_value"><?php if($profession_info['specialization']!='') { echo $profession_info['specialization']; } else{ echo "N/A"; }?></p>
										</div>
										<div class="row pb-3">
											<p class="col-md-4 attribute_name">University:</p>
											<p class="col-md-8 attribute_value"><?php if($profession_info['university']!='') { echo $profession_info['university']; } else{ echo "N/A"; }?></p>
										</div>
										...
										<div class="row pb-3">
										  	<p class="col-md-4 attribute_name">Post Graduation:</p>
											<p class="col-md-8 attribute_value"><?php  echo $education_info->kv_ue_pg; ?></p>
										</div>
										<?php if($education_info->kv_ue_pg_spec !='')  { ?>
										<div class="row pb-3">
											<p class="col-md-4 attribute_name">Specialization:</p>
											<p class="col-md-8 attribute_value"><?php echo $education_info->kv_ue_pg_spec; ?></p>
										</div>
										<?php } ?>
										<?php if($education_info->kv_ue_pg_univ !='')  { ?>
										<div class="row pb-3">
											<p class="col-md-4 attribute_name">University:</p>
											<p class="col-md-8 attribute_value"><?php echo $education_info->kv_ue_pg_univ; ?></p>
										</div>
										<?php } ?>
										<?php if($education_info->kv_ue_pg_college !='')  { ?>
										<div class="row pb-3">
											<p class="col-md-4 attribute_name">College:</p>
											<p class="col-md-8 attribute_value"><?php echo $education_info->kv_ue_pg_college; ?></p>
										</div>
										<?php } ?>
										...
										<div class="row pb-3">
										  	<p class="col-md-4 attribute_name">Graduation:</p>
											<p class="col-md-8 attribute_value"><?php  echo $education_info->kv_ue_g; ?></p>
										</div>
										<?php if($education_info->kv_ue_g_spec !='')  { ?>
										<div class="row pb-3">
											<p class="col-md-4 attribute_name">Specialization:</p>
											<p class="col-md-8 attribute_value"><?php echo $education_info->kv_ue_g_spec; ?></p>
										</div>
										<?php } ?>
										<?php if($education_info->kv_ue_g_univ !='')  { ?>
										<div class="row pb-3">
											<p class="col-md-4 attribute_name">University:</p>
											<p class="col-md-8 attribute_value"><?php echo $education_info->kv_ue_g_univ; ?></p>
										</div>
										<?php } ?>
										<?php if($education_info->kv_ue_g_college !='')  { ?>
										<div class="row pb-3">
											<p class="col-md-4 attribute_name">College:</p>
											<p class="col-md-8 attribute_value"><?php echo $education_info->kv_ue_g_college; ?></p>
										</div>
										<?php } ?>
							...
							<!--	<div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
									<div class="col-md-12 pt-4">
										<div class="row pb-3">
											...
											<p class="col-md-8 attribute_value">+91 - 9010101010</p>
										</div>
										<div class="row pb-3">
											<p class="col-md-4 attribute_name">Email:</p>
											<p class="col-md-8 attribute_value">Exapmle@gmail.com</p>
										</div>
										<div class="row pb-3">
											<p class="col-md-4 attribute_name">N/Aress:</p>
								...
								<!--		<div class="row pb-3">
										...
										<!-- <div class="row pb-3">
											...
											<p class="col-md-8 attribute_value"><?php if($siblings_info['no_of_brothers']!='') { echo $siblings_info['no_of_brothers']; } else{ echo "N/A"; }?></p>
										</div>
										<div class="row pb-3">
											<p class="col-md-4 attribute_name">No of Sisters:</p>
											<p class="col-md-8 attribute_value"><?php if($siblings_info['no_of_sisters']!='') { echo $siblings_info['no_of_sisters']; } else{ echo "N/A"; }?></p>
										</div> -->
									</div>
								<h6> Property Details:</h6>
									...
									<!--	<div class="row pb-3">
											...
											<p class="col-md-8 attribute_value"><?php if($property_info['property_Desc']!='') { echo $property_info['heighst_education']; } else{ echo "N/A"; }?></p>
										</div>  -->
									</div>
								</div>
								<!-- Tab 7 Ends Here -->
