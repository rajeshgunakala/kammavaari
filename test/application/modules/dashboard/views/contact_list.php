		...
		<div class="container">
			<div class="row main_content_top">
				<p class="col-md-12 heading">
					<span><?php echo $total_intrested_profiles;?></span>  Intrested Profiles 
				</p>
			</div>
			<div class="row">
				<div class="col-lg-9 col-md-8">
				
				<?php  foreach($intrest_profiles as $value){ ?>
						...
						<div class="col-lg-3 col-md-4 col-xs-12">
							<div class="team_thumb">
								...
								if($value['applicationphotopath']!="" && $fileExists && $value['ismain']==1 && $value['isactive']==1) { ?>
							            <img src="<?php echo $value['applicationphotopath']; ?>" class="dashboard_profile_img"  alt="<?php echo $value['last_name'];?>"> 
									 <?php } else{ ?>
