...
<section class="form-section">
    <div id="page-inner" class="col-xs-12 no-padding col-offset-xs-4">
        <div class="container">
           <div class="col-md-12">
              <h2><i class="fa fa-book" aria-hidden="true"></i> Profile Image Details</small></h2>
           </div>
        ...
        <div class="col-xs-12 bg-white">
            ...
            <div class="col-xs-12">
                <h3 class="page-header"> Upload New Photos</h3>
            ...
            <div class="col-xs-12 pull-right border-top-ms border-bottom-ms" style="display:none;">
        ...
        <div class="form-group">
          <select class="form-control" id="sel1">
            ...
            <div class="col-xs-12" style="border-top: solid 1px #ccc; margin-top: 20px; padding-top: 20px;">
                ...
                <div class="col-xs-2 photo2_upload_ms"></div>
                <div class="col-xs-2 photo3_upload_ms"></div>
            </div>
            ...
            <div class="col-xs-12 text-center small_txt_ms no-margin">
               You can email your photos with your profile id to <a href="mailto:info@kammavaari.com?subject = Feedback&body = Message">info@kammavaari.com</a>
            </div>
            </form>
        </div>
        </div>
