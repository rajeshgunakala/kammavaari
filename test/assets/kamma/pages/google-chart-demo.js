...
$(function () {
  ...
  function drawVisualization() {
    ...
    var options = {
      ...
      colors: ['#3281f2', '#5b9af5', '#69adf0', '#2e78e1', '#e9ecef', "#132843"],
      series: {5: {type: 'line'}}
    };
  ...
  function drawChart6() {
    ...
    var options = {
      ...
      height: 340,
      fontSize: 12,
      colors: ['#3281f2', '#5b9af5', '#69adf0', '#2e78e1', '#e9ecef']
    };
  ...
  function drawChart7() {
    ...
    var options = {
      ...
      height: 340,
      fontSize: 12,
      colors: ['#3281f2', '#5b9af5', '#2e78e1', '#e9ecef', '#69adf0']
    };
  ...
  function drawChart8() {
    ...
    var options = {
      ...
      height: 340,
      fontSize: 12,
      colors: ['#69adf0','#3281f2', '#5b9af5',  '#2e78e1', '#e9ecef']
    };
  ...
  function drawChart9() {
    ...
    var options = {
      ...
      height: 340,
      fontSize: 12,
      colors: ['#69adf0','#3281f2', '#5b9af5',  '#2e78e1', '#e9ecef','#69adf0','#3281f2', '#5b9af5',  '#2e78e1', '#e9ecef','#69adf0','#3281f2', '#5b9af5',  '#2e78e1', '#e9ecef','#69adf0','#3281f2', '#5b9af5',  '#2e78e1', '#e9ecef','#69adf0','#3281f2']
    };
