		...
		<div class="vmagazine-lite-container clearfix">			
			<nav id="site-navigation" class="main-navigation clearfix" >
				<div class="nav-wrapper">
					...
					<?php wp_nav_menu( array( 'theme_location' => 'primary_menu','container_class'=>'menu-mmnu-container' ) ); ?>
				</div><!-- .nav-wrapper -->
			</nav><!-- #site-navigation -->
	...
	function vmagazine_lite_credit() {
		...
		?>
				<div class="site-info">
		            ...
		            <?php echo esc_html__('WordPress Theme :', 'vmagazine-lite'); ?> <a href="<?php echo esc_url('https://accesspressthemes.com/wordpress-themes/vmagazine-lite/')?>" target="_blank"><?php echo esc_html($theme->name); ?></a> 
				</div><!-- .site-info -->				
		<?php
	}
}
