							...
							<div class="col-xs-12">
								...
								<div class="error-container">
									<div class="well">
										...
										<div class"col-md-12">
										<img src="<?php echo site_url(); ?>assets/css/images/royalitpark-admin-bg.png" class="img-responsive"  />
										</div>
										...
										<div class="center">
											<a href="<?php ADMIN_URL; ?>Logout" class="btn btn-grey">
												<i class="ace-icon fa fa-arrow-left"></i>
												Logout
											</a>

											<a href="<?php echo ADMIN_URL; ?>Websettings" class="btn btn-primary">
