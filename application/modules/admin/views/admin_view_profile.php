...
<div class="main-container">
  <div class="container no-padding" style="margin-top: 4px;margin-bottom: 20px;background-color: white;">
    <div class="col-xs-12 col-md-12 col-lg-12 no-padding" style="margin-top: 80px;">
      <h1 class="page-header" style="padding-left:10px;"> Complete Profile      </h1>
    </div>
        ...
        <div class="view-profile col-xs-12 col-md-12 no-padding">
          ...
          <?php if ($profession_info['about_profession'] != "") { ?>
            <div class="preson-details">
              ...
              <p><strong>Annual Income:</strong> <?php echo !empty($profession_info['annual_income']) ? ucwords($profession_info['annual_income']) : "NA"; ?></p>
            </div>
            <div class="col-xs-12"> &nbsp;</div>
          <?php	} else { ?>
            <div class="preson-details">
          ...
          <div class="preson-details">
            <table class="responsive_table">
				<tr>
					...
					<td><?php
						...
						if (!empty($parents_info['father_profession'])) {
						 ...
						 if (!empty($parents_info['father_semiprof_det'])) {
							$fatherDetails.= ", " . $parents_info['father_semiprof_det'];
						}
				...
				<?php if ($parents_info['father_mobile'] != "") { ?>
				 ...
				 <tr><td class="strongbold">Father Father Name And Native</td><td class="colon_pad">:</td><td><?php echo ucwords($parents_info['fathers_father_name']); ?> , <?php echo ucwords($parents_info['fathers_father_native_place']); ?>, <?php echo ucwords($parents_info['fathers_father_district']); ?> Dist </td></tr>
				<?php } ?>
				<tr><td class="strongbold">Mother Name</td><td class="colon_pad">:</td>
					<td><?php
						...
						if (!empty($parents_info['mother_profession'])) {
						 ...
						 if (!empty($parents_info['mother_semiprof_det'])) {
							$motherDetails.= ", " . $parents_info['mother_semiprof_det'];
						}
				...
				<?php if ($parents_info['mother_mobile'] != "") { ?>
				 ...
				 <tr><td class="strongbold">Mother Father And Native</td><td class="colon_pad">:</td><td><?php echo ucwords($parents_info['mothers_father_name']); ?>, <?php echo ucwords($parents_info['mothers_father_native_place']); ?>, <?php echo ucwords($parents_info['mothers_father_district']); ?> Dist </td></tr>
				 <?php } ?>
         
				<?php if ($siblings_info['no_of_elder_brothers'] != 0 && $brothers_info['brother_type'] == "elder") { ?>
				  <tr><td class="strongbold">No. Of Elder Brothers</td><td class="colon_pad">:</td><td> <?php echo $siblings_info['no_of_elder_brothers'] . ',' . $brothers_info['brother_name']  . ',' .$brothers_info['brother_education']  .','.$brothers_info['brother_joblocation'] ?></td></tr>
				<?php } ?>

				<?php if ($siblings_info['no_of_younger_brothers'] != 0 && $brothers_info['brother_type'] == "younger") { ?>
				   <tr><td class="strongbold">No. Of Younger Brothers</td><td class="colon_pad">:</td><td><?php echo $siblings_info['no_of_younger_brothers'] . ',' . $brothers_info['brother_name'] .  ',' .$brothers_info['brother_education']  .','.$brothers_info['brother_joblocation']  ?></td></tr>
				<?php } ?>
				
				 <!--<?php if ($brothers_info['user_id'] != null) { ?>-->
				   <tr><td class="strongbold">Married status of Brother</td><td class="colon_pad">:</td><td><?php echo $brothers_info['married_type']; ?></td></tr>
				<!--<?php } ?>-->
				
        <?php if ($siblings_info['no_of_elder_sisters'] != 0) { ?>
    <tr>
        <td class="strongbold">No. Of Elder Sisters: <?php echo $siblings_info['no_of_elder_sisters']; ?></td>
        <td class="colon_pad">:</td>
        <td>
            <?php
            foreach ($sisters_info as $sister) {
                echo $sister['sister_name'] . ', ' . $sister['sister_education'] . ', ' . $sister['sister_joblocation'] .','.$sister['married_type'] . '<br>';
            }
            ?>
        </td>
    </tr>
...
<?php if ($siblings_info['no_of_younger_sisters'] != 0) { ?>
    <tr>
        <td class="strongbold">No. Of Younger Sisters: <?php echo $siblings_info['no_of_younger_sisters']; ?></td>
        <td class="colon_pad">:</td>
        <td>
            <?php
            foreach ($sisters_info as $sister) {
...
<?php } ?>
				...
				<tr><td class="strongbold">Parents Current Location</td><td class="colon_pad">:</td><td><?php echo $contact_info['city']; ?> </td></tr>
			</table>
          </div>
          <div class="col-xs-12"> &nbsp;
          </div>
