					...
					<div class="page-content">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
										...
										<div class="col-sm-9">
											<select type="text" id="form-field-1"  required name="education_id"  class="col-xs-10 col-sm-5"/>
											<option>Select</option>
											<?php foreach($heighsteducations as $value) { ?>
											<option <?php if($value['id'] == $record['hid']) {?>  selected <?php }?>value="<?php echo $value['id'];?>"><?php echo ucwords($value['heighsteducation']);?></option>
											<?php } ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1"  required name="degree" placeholder="Enter Degree" value="<?php echo $record['educationdegree'];?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										...
										<div class="col-md-offset-3 col-md-9">
											...
											<a class="btn" href="<?php echo ADMIN_URL;?>Degree">
