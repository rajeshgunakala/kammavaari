							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="myform" id="myform" method="post" enctype="multipart/form-data" role="form">
										...
										<div class="col-sm-9">
											...
											<option value="<?php echo $value['id'];?>"><?php echo ucwords($value['heighsteducation']);?></option>
											<?php } ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<option>Select Heighst Education First</option></select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Specialization </label>
										<div class="col-sm-9"> 
										<input type="text" name="specialization" required class="col-xs-10 col-sm-5" placeholder="Enter Specialization"/>
										</div>
									</div>
