...
<div class="row">
            ...
            <div class="col-md-9 col-xs-12" style="margin-top: 80px;"> 
...
<thead style="background-color:#fd9f17; color:white;">
  <tr class="th" >   
  <th width="20%" align="center" valign="middle">SL.NO</th>
...
<td><?php echo $ji ?></td>
  ...
  <td align="center" valign="middle">
    <a href="<?php echo base_url();?>admin/admin_search/viewprofile/<?php echo $hold->id;?>" target="_blank">View Profile</a> | 
    <a href="<?php echo base_url();?>admin/call_history?profileId=<?php echo $hold->profile_id;?>" target="_blank">Marketing</a>
  </td>
