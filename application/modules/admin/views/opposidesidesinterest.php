...
<div class="col-md-9 no-padding" style="margin-top: 10px;">
   <div class="col-md-12 no-padding">
      <h3 style="text-align:center;">Opposite Side Interested</h3>
                  ...
                  <div class="col-sm-12 compareprofile">
                     <div class="completeProfileLeftPanWrapper">
                        <div class="CPProfileImgNameOuter">
                           ...
                           <div class="CPProfileName"> <?php echo ucfirst($primary_info2['first_name'] . ' ' . $primary_info2['last_name']);?> (<a href="<?php echo base_url();?>admin/admin_search/viewprofile/<?php echo $profile_2;?>" target="_blank"><?php echo $primary_info2['profile_id'];?></a>) <span><img src="<?php echo base_url();?>images/heartblink.gif" width="20" style="text-align:center;" /></span></div>
